...
├── backtest_v4_dca_hybrid_no_filter_*.png (含 AI 信心度標註)
├── daily_confidence_v4_dca_hybrid_no_filter_*.csv (每日 AI 狀態與信心)
├── metrics_v4_dca_hybrid_no_filter_*.csv
└── trades_v4_dca_hybrid_no_filter_*.csv
```
